...
### config=baseline, strategy=fifo ###

set terminal svg size 1200 900

# plot 1. x-axis: products, y-axis: flow time of product

set out 'plot_products_baseline_fifo.svg'
set title "Flow Time (config=baseline, strategy=fifo)"
set xlabel "Product #"
set ylabel "Minutes"
...
### config=add-new-machines, strategy=fifo ###

set terminal svg size 1200 900

# plot 1. x-axis: products, y-axis: flow time of product

set out 'plot_products_add-new-machines_fifo.svg'
set title "Flow Time (config=add-new-machines, strategy=fifo)"
set xlabel "Product #"
set ylabel "Minutes"
set key title "Max Wait (min)"
set key bottom center out
...
plot 'output_add-new-machines_fifo.csv' \
    using 1:2 title '0' w boxes ls 1, \
 '' using 1:3 title '3' w boxes ls 2, \
 '' using 1:4 title '6' w boxes ls 3
...
### config=double-capacity, strategy=fifo ###

set terminal svg size 1200 900

# plot 1. x-axis: products, y-axis: flow time of product

set out 'plot_products_double-capacity_fifo.svg'
set title "Flow Time (config=double-capacity, strategy=fifo)"
set xlabel "Product #"
set ylabel "Minutes"
set key title "Max Wait (min)"
set key bottom center out
...
plot 'output_double-capacity_fifo.csv' \
    using 1:2 title '0' w boxes ls 1, \
 '' using 1:3 title '3' w boxes ls 2, \
 '' using 1:4 title '6' w boxes ls 3
...
### config=double-speed, strategy=fifo ###

set terminal svg size 1200 900

# plot 1. x-axis: products, y-axis: flow time of product

set out 'plot_products_double-speed_fifo.svg'
set title "Flow Time (config=double-speed, strategy=fifo)"
set xlabel "Product #"
set ylabel "Minutes"
set key title "Max Wait (min)"
set key bottom center out
...
plot 'output_double-speed_fifo.csv' \
    using 1:2 title '0' w boxes ls 1, \
 '' using 1:3 title '3' w boxes ls 2, \
 '' using 1:4 title '6' w boxes ls 3
...
set out 'plot_box_baseline_fifo.svg'
set title "Flow Time Distribution (config=baseline, strategy=fifo)"
...
set out 'plot_box_add-new-machines_fifo.svg'
set title "Flow Time Distribution (config=add-new-machines, strategy=fifo)"
set style fill solid 0.25 border -1
set style boxplot outliers pointtype 7
set style data boxplot
set key off
...
set out 'plot_box_double-capacity_fifo.svg'
set title "Flow Time Distribution (config=double-capacity, strategy=fifo)"
set style fill solid 0.25 border -1
set style boxplot outliers pointtype 7
set style data boxplot
set key off
...
set out 'plot_box_double-speed_fifo.svg'
set title "Flow Time Distribution (config=double-speed, strategy=fifo)"
set style fill solid 0.25 border -1
set style boxplot outliers pointtype 7
set style data boxplot
set key off
...
set out 'plot_freq_baseline_fifo.svg'
set title "Frequency of flow times (config=baseline, strategy=fifo)"
...
set out 'plot_freq_add-new-machines_fifo.svg'
set title "Frequency of flow times (config=add-new-machines, strategy=fifo)"
set boxwidth (bin_width) absolute
set style fill solid 1.0 noborder
...
set out 'plot_freq_double-capacity_fifo.svg'
set title "Frequency of flow times (config=double-capacity, strategy=fifo)"
set boxwidth (bin_width) absolute
set style fill solid 1.0 noborder
...
set out 'plot_freq_double-speed_fifo.svg'
set title "Frequency of flow times (config=double-speed, strategy=fifo)"
set boxwidth (bin_width) absolute
set style fill solid 1.0 noborder
